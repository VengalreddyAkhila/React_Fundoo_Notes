...
const SignInPage = () => {
      return(
        ...
        <div className='sign-in-container'>
            ...
            <input name="First name" type="name" value="First name" onChange={handler}></input>
            <input name="Last name" type="name" value="Last name"></input>
            </div>

            <div className='email-field'>
            <input name="User name" type="name" value="User name"></input>
            </div>

            <div className='label-container' id='password-field'>
            <input name="Password" type="name" value="password"></input>
            <input name="Confirm Password" type="name" value="Confirm Password"></input>
            </div>
